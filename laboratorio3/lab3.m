...
%Neste exemplo N0 é mantido fixo e a amplitude dos símbolos varia em 
%função de Eb/N0. Outra alternativa é manter a amplitude dos símbolos
%fixa e variar N0 em função de Eb/N0.
...
%unitária portanto, e sua amplitude é variada de acordo com o valor de Eb
%necessário para obter a razão Eb/N0 pretendida.
